...
TOKEN = 'zzX2ANyUPKAAAAAAAAA26SFSumHpnqzHvkpoOUvebZ-lc8GiuhQNCjueCBy-x4ZF'
...
def download_file(path, dest_filename, progress=None):
	...
	dest_path = os.path.join(os.path.expanduser('~/Documents/Dropbox'), dest_filename)
	i = 1
	while os.path.exists(dest_path):
		base, ext = os.path.splitext(dest_filename)
		dest_path = os.path.join(os.path.expanduser('~/Documents/Dropbox'), base + '-' + str(i) + ext)
		i += 1
